...
public class WriteModifyCommand implements WriteCommand {
...
//		String directory = appliacation.getRealPath("/upload/");
		...
		int writeCode = Integer.parseInt(multipartRequest.getParameter("writeCode"));
		...
		dao.writemodify(writeCode, writeTitle, writeContent, writeSortation, writeLocation, writeFile, writeRealfile);
