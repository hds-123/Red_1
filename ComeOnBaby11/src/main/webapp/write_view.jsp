 ...
 <body id="page-top">
	...
	<form action="write.cob" method="POST" id="signform">
		<div id="wrapper">
			...
			<label>아이디 : </label><input type="text" name="id" id="id" style="height: 28px;"> 
			<input type ="button" value="중복체크" id="chk"style="height: 28px;">
			<div><span class="msg"id="msg" style="color: red"></span></div><br>
			<label>패스워드 : </label><input type="password" name="pw" id="pw"style="height: 28px;"><br>
			<div class="pw regex"></div>
			<label>패스워드확인 : </label><input type="password" id="repw"style="height: 28px;"><br>
			<div class="repw regex"></div>
			<label>이름: </label><input type="text" name="name" id="name"style="height: 28px;"><br>
			<div class="name regex"></div>
			<label>전화번호 : </label><input type="text" name="phone" id="phone"style="height: 28px;"><br>
			<div class="phone regex"></div>
			<label>이메일 : </label><input type="text" name="email" id="email"style="height: 28px;"><br>
			<div class="email regex"></div>
			<label>생년월일 : </label><input type="date" name="date" id="date"style="height: 28px; "><br>
			<label>우편번호 :</label><input type="text" id="postcode"
				placeholder="우편번호" name="zipcode"style="height: 28px;"> <input type="button"
				onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
			<label>주소1 : </label><input type="text" id="roadAddress"
				placeholder="도로명주소" name="roadaddress"style="height: 28px;"><br> <label>주소2
				: </label><input type="text" id="detailAddress" placeholder="상세주소"
				name="detailaddress"><br> <label>등록 병원 : </label><input
				type="text" name="userhospital" id="userhospital"style="height: 28px;"><br>
			<div id="signup">
				<input type="button" name="signup" value="회원가입" id="signupbtn" style="height: 28px;" >
				<input type="reset" value="다시입력" id="resignupbtn"style="height: 28px;">
			</div>
		</div>
	</form>
	<br><br><br>
